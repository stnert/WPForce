...
## ABOUT:
WP Force is a suite of Wordpress Attack tools.  Cuurrently this contains 2 modules - WPforce, which brute forces logins via the API, and Yertle, which uploads shells once admin credentials have been found.
## FEATURES:
